...
with open('windowlength7.txt','w') as f:
    f.write(str(result1.history))

model.save('windowlength7.h5')
...
with open('windowlength10.txt','w') as f:
    f.write(str(result2.history))

model.save('windowlength10.h5')
...
with open('RSA_windowlength13.txt','w') as f:
    f.write(str(result3.history))

model.save('RSA_windowlength13.h5')
...
plt.ylabel('Loss')
plt.plot(result1.epoch, result1.history['loss'], 'red', lw=2, label = 'Window Length = 7')
plt.plot(result2.epoch, result2.history['loss'], 'green', lw=2, label = 'Window Length = 10')
plt.plot(result3.epoch, result3.history['loss'], 'blue', lw=2, label = 'Window Length = 13')
plt.legend()
plt.savefig("RSA_nwindowlength_loss_result.eps", format='eps', dpi=1000)
plt.show()
